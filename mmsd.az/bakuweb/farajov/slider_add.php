    ...
    <body>
        <?php
            ...
            if($conn){
              ...
              if(isset($_GET['axtar'])){
                if($_GET['axtar'] != ""){
                  ...
                  echo "<script type='text/javascript'>window.location='slider_add.php?page=1'</script>";
                }
              }else{
              ...
              if(isset($_GET['kat']) && is_numeric($_GET['kat']) && $_GET['kat'] > 0){
                //eger kateqoriya 9dan kicikdirse normal davam et deyilse kateqoriyani legv et
                if($_GET['kat'] < 9){
            ...
            if($_GET['page'] > $cemi_sehife_sayi){
              echo "<script type='text/javascript'>alert('Getmək istədiyiniz səhifə, mövcud səhifə sayından çoxdur. Son səhifəyə yönləndirilirsiniz.');window.location='slider_add.php?page=".$cemi_sehife_sayi.$isset_kat.$isset_axtar."'</script>";
            }
        ?>
                ...
                <div class="span9" id="content">
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <p class="p_header_admin">Sliderə Xəbər Əlavə Et
                              <?php
                                if($xeber_var){
                                  ...
                                  <table class="table siralama_table">
                                    ...
                                    <table class="table table-bordered table-hover xeber_sil_table">
                                      ...
                                      <tbody>
                                        <?php
                                          if($conn){
                                            $select = "SELECT id,basliq,oxunma_sayi,kateqoriya,tmp,tarix,saat,slider FROM news ";
                                            $select .= $add_to_select_sql_kat;
                                            $select .= $axtarilan_id;
                                            $select .= $axtarilan_basliq;
                                            ...
                                            while($row = mysqli_fetch_assoc($netice)){
                                              ...
                                              echo "<tr class='xeber_".$row['id']."'>
                                                      ...
                                                      <td class='tb_id'><button ".$disable." class='btn btn-info edit_btn slider_add_btn' onclick='add_to_slider(this.id)' id='edit".$row['id']."'><i class='fa fa-plus' aria-hidden='true'></i></button></td>
                                                    </tr>";
                                            }
                                      ...
                                      <ul>
                                        <?php
                                          if($cemi_sehife_sayi > 5){
                                            ...
                                            $next = $sehife+1;
                                            if($sehife == 1){
                                                echo "<li class='active'><a href='slider_add.php?page=".$bir.$isset_kat.$isset_axtar."'>".$bir."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$iki.$isset_kat.$isset_axtar."'>".$iki."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$uc.$isset_kat.$isset_axtar."'>".$uc."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$dord.$isset_kat.$isset_axtar."'>".$dord."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$bes.$isset_kat.$isset_axtar."'>".$bes."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$next.$isset_kat.$isset_axtar."'> > </a></li>";
                                            }else if($sehife == 2){
                                              echo "<li><a href='slider_add.php?page=".$prev.$isset_kat.$isset_axtar."'> < </a></li>";
                                                echo "<li><a href='slider_add.php?page=".$bir.$isset_kat.$isset_axtar."'>".$bir."</a></li>";
                                                echo "<li class='active'><a href='slider_add.php?page=".$iki.$isset_kat.$isset_axtar."'>".$iki."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$uc.$isset_kat.$isset_axtar."'>".$uc."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$dord.$isset_kat.$isset_axtar."'>".$dord."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$bes.$isset_kat.$isset_axtar."'>".$bes."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$next.$isset_kat.$isset_axtar."'> > </a></li>";
                                                ...
                                                echo "<li><a href='slider_add.php?page=".$bir.$isset_kat.$isset_axtar."'>".$bir."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$iki.$isset_kat.$isset_axtar."'>".$iki."</a></li>";
                                                echo "<li class='active'><a href='slider_add.php?page=".$uc.$isset_kat.$isset_axtar."'>".$uc."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$dord.$isset_kat.$isset_axtar."'>".$dord."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$bes.$isset_kat.$isset_axtar."'>".$bes."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$next.$isset_kat.$isset_axtar."'> > </a></li>";
                                                ...
                                                echo "<li><a href='slider_add.php?page=".$iki.$isset_kat.$isset_axtar."'>".$iki."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$uc.$isset_kat.$isset_axtar."'>".$uc."</a></li>";
                                                echo "<li class='active'><a href='slider_add.php?page=".$dord.$isset_kat.$isset_axtar."'>".$dord."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$bes.$isset_kat.$isset_axtar."'>".$bes."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$next.$isset_kat.$isset_axtar."'> > </a></li>";
                                                ...
                                                echo "<li><a href='slider_add.php?page=".$uc.$isset_kat.$isset_axtar."'>".$uc."</a></li>";
                                                echo "<li><a href='slider_add.php?page=".$dord.$isset_kat.$isset_axtar."'>".$dord."</a></li>";
                                                echo "<li class='active'><a href='slider_add.php?page=".$bes.$isset_kat.$isset_axtar."'>".$bes."</a></li>";
                                            }

                                          }else{
                                              for($a=1; $a<=$cemi_sehife_sayi; $a++){ 
                                                  echo "<li id='sehife".$a."'><a href='slider_add.php?page=".$a.$isset_kat.$isset_axtar."'>".$a."</a></li>"; 
                                              };
        ...
        <script>
            ...
            function pass_value_to_session(){
              ...
              $.ajax({
                ...
                success:function(){
                  ...
                  if(kat != ""){
                    window.location='slider_add.php?page=1&kat='+kat;
                  }else{
                    window.location='slider_add.php?page=1';
                  }
                }
              });
            }
            ...
            function axtarilan_basliq(){
              ...
              if(!/^[a-zA-Z0-9əƏşŞçÇöÖğĞüÜıIİ .,]*$/g.test(axtarilan_basliq)){
                ...
                window.location='slider_add.php?page=1&axtar='+axtarilan_basliq;
              }
            }
            ...
            function axtarilan_id_getir(){
              ...
              if(axtarilan_id > 0){
                window.location='slider_add.php?page=1&id='+axtarilan_id;
              }else{
            ...
            function go_to_page(){
              ...
              if(gedilecek_sehife != ""){
                ...
                if(gedilecek_sehife > cemi_sehife_sayi){
                  ...
                  if(kat != ""){
                    window.location='slider_add.php?page='+gedilecek_sehife+'&kat='+kat;
                  }else{
                    window.location='slider_add.php?page='+gedilecek_sehife;
                  }
                  if(axtar_hidden_input != ""){
                    window.location='slider_add.php?page='+gedilecek_sehife+'&axtar='+axtar_hidden_input;
                  }
                }
              }else{
